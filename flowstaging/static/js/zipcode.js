var zipcode = {
  ...
  '苗栗縣': {
    '竹南鎮':'350', '頭份鎮':'351', '三灣鄉':'352', '南莊鄉':'353', '獅潭鄉':'354', '後龍鎮':'356',
    '通霄鎮':'357', '苑裡鎮':'358', '苗栗市':'360', '造橋鄉':'361', '頭屋鄉':'362', '公館鄉':'363',
    '大湖鄉':'364', '泰安鄉':'365', '銅鑼鄉':'366', '三義鄉':'367', '西湖鄉':'368', '卓蘭鎮':'369'
  },
  '台中市': {'中區':'400', '東區':'401', '南區':'402', '西區':'403', '北區':'404', '北屯區':'406', '西屯區':'407', '南屯區':'408'},
  '台中縣': {
    '太平市':'411', '大裡市':'412', '霧峰鄉':'413', '烏日鄉':'414', '豐原市':'420', '後裡鄉':'421',
  ...
  '南投縣': {
    ...
    '名間鄉':'551', '集集鎮':'552', '水裡鄉':'553', '魚池鄉':'555', '信義鄉':'556', '竹山鎮':'557',
    '鹿谷鄉':'558'
  },
  '嘉義市': {'嘉義市':'600'},
  '嘉義縣': {
  ...
  '屏東縣': {
    '屏東市':'900', '三地門':'901', '霧臺鄉':'902', '瑪家鄉':'903', '九如鄉':'904', '裡港鄉':'905',
  ...
  '台東縣': {
    ...
    '太麻裡鄉':'963', '金峰鄉':'964', '大武鄉':'965', '達仁鄉':'966'
  },
  '花蓮縣': {
    '花蓮市':'970', '新城鄉':'971', '秀林鄉':'972', '吉安鄉':'973', '壽豐鄉':'974', '鳳林鎮':'975',
    '光復鄉':'976', '豐濱鄉':'977', '瑞穗鄉':'978', '萬榮鄉':'979', '玉裡鎮':'981', '卓溪鄉':'982',
    '富裡鄉':'983'
  },
