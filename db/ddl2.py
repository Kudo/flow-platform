...
#
# *** UNIT-TEST ***
# 1. Prepare an "app.yaml", the script line should be "script: ddl2.py", and save the file where this ddl2.py is saved.
...
class NpoProfile(FlowDdlModel):
    ...
    def __init__(self, parent=None, key_name=None, app=None, _from_entity=False, **kargs):
        ...
        if "npo_id" not in kargs:
            kargs["npo_id"] = kargs["npo_category"] + ":" + str(id)
...
class NpoEmail(FlowDdlModel):
    ...
    def __init__(self, parent=None, key_name=None, app=None, _from_entity=False, **kargs):
        ...
        kargs["npo_profile_id"] = kargs["npo_profile_ref"].id
...
class VolunteerProfile(FlowDdlModel):
    ...
    def __init__(self, parent=None, key_name=None, app=None, _from_entity=False, **kargs):
        ...
        if not "valid_google_acct" in kargs:
            kargs["valid_google_acct"] = True
        if not "hide_cellphone" in kargs:
            kargs["hide_cellphone"] = False
        if not "total_serv_hours" in kargs:
            kargs["total_serv_hours"] = 0
        if not "total_reg_events" in kargs:
            kargs["total_reg_events"] = 0
        if not "total_serv_events" in kargs:
...
class EventProfile(FlowDdlModel):
    ...
    origiginator               = db.UserProperty()            # auto-generated from volunteer_profile_ref.volunteer_id
    ...
    def __init__(self, parent=None, key_name=None, app=None, _from_entity=False, **kargs):
        ...
        kargs["npo_profile_id"]       = kargs["npo_profile_ref"].id
        kargs["npo_id"]               = kargs["npo_profile_ref"].npo_id
        kargs["volunteer_profile_id"] = kargs["volunteer_profile_ref"].id
        kargs["origiginator"]         = kargs["volunteer_profile_ref"].volunteer_id
        ...
        kargs["questionnaire_template_id"] = kargs["questionnaire_template_ref"].id

        FlowDdlModel.__init__(self, parent, key_name, app, _from_entity, **kargs)

    @staticmethod
    def unitTest(npo, volunteer, template):
...
class VolunteerEvent(FlowDdlModel):
    ...
    def __init__(self, parent=None, key_name=None, app=None, _from_entity=False, **kargs):
        ...
        kargs["volunteer_profile_id"] = kargs["volunteer_profile_ref"].id
        kargs["volunteer_id"]         = kargs["volunteer_profile_ref"].volunteer_id
        kargs["event_profile_id"]     = kargs["event_profile_ref"].id
        kargs["event_id"]             = kargs["event_profile_ref"].event_id

        FlowDdlModel.__init__(self, parent, key_name, app, _from_entity, **kargs)

    @staticmethod
    def unitTest(volunteer, event):
...
class EventQuestion(FlowDdlModel):
    ...
    def __init__(self, parent=None, key_name=None, app=None, _from_entity=False, **kargs):
        ...
        kargs["event_id"]             = kargs["event_profile_ref"].event_id
        kargs["volunteer_profile_id"] = kargs["volunteer_profile_ref"].id
        kargs["questioner"]           = kargs["volunteer_profile_ref"].volunteer_id
...
class EventAnswer(FlowDdlModel):
    ...
    def __init__(self, parent=None, key_name=None, app=None, _from_entity=False, **kargs):
        ...
        kargs["event_question_id"]    = kargs["event_question_ref"].id
        kargs["volunteer_profile_id"] = kargs["volunteer_profile_ref"].id
        kargs["volunteer_id"]         = kargs["volunteer_profile_ref"].volunteer_id
    ...
    @staticmethod
    def unitTest(volunteer, question):
...
class EventQuestionnaire(FlowDdlModel):
    ...
    def __init__(self, parent=None, key_name=None, app=None, _from_entity=False, **kargs):
        ...
        kargs["questionnaire_template_id"] = kargs["questionnaire_template_ref"].id
        kargs["volunteer_profile_id"]      = kargs["volunteer_profile_ref"].id
        kargs["respondent"]                = kargs["volunteer_profile_ref"].volunteer_id

        FlowDdlModel.__init__(self, parent, key_name, app, _from_entity, **kargs)

    @staticmethod
    def unitTest(volunteer, event, template):
...
class EventReport(FlowDdlModel):
    ...
    def __init__(self, parent=None, key_name=None, app=None, _from_entity=False, **kargs):
        ...
        kargs["event_profile_id"]     = kargs["event_profile_ref"].id
        kargs["event_id"]             = kargs["event_profile_ref"].event_id
        kargs["report_template_id"]   = kargs["report_template_ref"].id
        kargs["volunteer_profile_id"] = kargs["volunteer_profile_ref"].id
        kargs["reporter"]             = kargs["volunteer_profile_ref"].volunteer_id
...
# tester[0]: The web application object, use tester[0].response.out as the output stream.
